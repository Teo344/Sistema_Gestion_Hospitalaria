...
async function fetchGet(url, tipoRespuesta, callback) {
    try {
        ...
        console.error("Error en fetchGet:", e); // Depuración
    ...
    for (let i = 0; i < numRegistros; i++) {
        ...
        if (objConfiguracionGlobal.editar == true || objConfiguracionGlobal.eliminar == true) {
            ...
            if (objConfiguracionGlobal.editar == true) {
                contenido += `<i class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
            ...
            if (objConfiguracionGlobal.eliminar == true) {
                contenido += `<i class="btn btn-danger"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3-fill" viewBox="0 0 16 16">
